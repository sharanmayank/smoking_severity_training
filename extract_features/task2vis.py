...
"""Generate animation of the data for task 2 for a given subject"""
"""Moving white box represents the location of the cross"""
"""The task was to follow the cross"""

r = 3

subj_id = 'S01'

root_dir = '../data/' + subj_id + '/task2/'
